...
class MultiGPUSparseAdjDataBatchGenerator(object):
    ...
    def __iter__(self):
        ...
        for a in range(0, n, bs):
            ...
            # simPatients_id = [patient_sim[qid] for qid in batch_qids] # 相似患者的id集合 of shape (bsz, 10)
            simPatients_qid = []
            num_simPatients = 7
            ...
            for idxs in simPatients_qid: # 将相似患者的id（mimic iii中qid）转换为索引（0～6000）
            ...
            # 得到每个患者的 sim_mask_mult, sim_mask_code, sim_seq_time_step, sim_lengths, sim_seq_time_step2, sim_age, sim_gender, sim_ethicties
            sim_mask_mult = []
            sim_mask_code = []
            sim_seq_time_step = []
            sim_lengths = []
            ...
            # 得到每个患者的 mask_mult, mask_code, seq_time_step, lengths, seq_time_step2
